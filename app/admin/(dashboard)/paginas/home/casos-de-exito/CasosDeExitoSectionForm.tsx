  ...
  return (
    <form action={formAction} className="flex flex-col gap-6 max-w-[560px]">
      ...
      <p className="text-title-md text-white/40">
        Las fotos que se muestran acá son las primeras 3 visibles de{" "}
        <Link href="/admin/casos-reales" className="underline hover:text-white/70 transition-colors">
          Casos reales
        </Link>
        . Para cambiar cuáles aparecen, reordená o mostrá/ocultá casos ahí.
      </p>
